  ...
  <div class="chat-page">
    <n-layout has-sider class="chat-layout">
      ...
      >
        ...
        <n-list class="conversation-list">
          <n-list-item
            ...
            <template #suffix>
              <n-space>
                ...
                <n-popconfirm @positive-click="handleDelete(conv.id)">
                  <template #trigger>
                    <n-tooltip content="删除" placement="top">
...
import {
  chat, getConversations, getConversation,
...
function scrollToBottom() {
  ...
  if (chatContentRef.value) {
    const container = chatContentRef.value.$el || chatContentRef.value
